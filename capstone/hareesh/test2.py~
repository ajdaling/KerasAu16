...
dataset = pandas.read_csv("/nfs/09/osu9669/work/particleFlow/TorchData/ttHbb_Btag/ttHbb_btag.txt", delimiter=",", header=None,dtype='a',nrows=nlines)
...
dataset = pandas.read_csv("/nfs/09/osu9669/work/particleFlow/TorchData/ttjets_Btag/ttjets_btag.txt", delimiter=",", header=None,dtype='a',nrows=nlines)
...
#save model to file
model.save('model_32x32_35k.h5')
print('saved model once')

model_json = model.to_json()
with open('model_32x32_35k.json','w+') as json_file:
	json_file.write(model_json)
print('saved model twice')
#save weights to file
model.save_weights('weights_32x32_35k.h5')
print('saved weights')
