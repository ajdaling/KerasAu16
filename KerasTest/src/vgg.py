...
# borrowed from https://blog.keras.io/how-convolutional-neural-networks-see-the-world.html
...
#load weights (we are leaving out fully connected layer so parse manually
import h5py
